...
class InvalidName___Class_0x00___ColorizeVisitor_5 < Prism::Visitor
...
class IRB::Irb
  ...
  def self.run_nesting_depth; end
  def self.run_nesting_depth=(arg0); end
